...
<template>
  <div class="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-center">
    <div class="relative mb-8">
      ...
      <img src="/logo.png" alt="Slavia Logo" class="relative h-40 w-auto opacity-20 grayscale transition-all hover:opacity-100 hover:grayscale-0" />
    ...
    <div class="mt-20 flex items-center gap-4 text-muted/30">
      <UIcon name="i-lucide-dumbbell" class="size-10" />
